...
\newcommand{\TITLE}{A Collaborative Approach to Detecting Home Network Bottlenecks}
...
\textbf{\ttlfnt \TITLE}}
\author{
%\aufnt{Sarthak Grover\gt} \\
%\gt\affaddr{Georgia Tech}
\aufnt{Sarthak Grover\gt, Anna-Kaisa Pietilainen\inr, Renata Tiexiera\inr}\\
\aufnt{Christian Kreibich\icsi, Nick Feamster\gt, ...} \\
